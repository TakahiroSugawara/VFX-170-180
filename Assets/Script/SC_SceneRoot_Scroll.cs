...
public class SC_SceneRoot_Scroll : MonoBehaviour
{
    ...
    void Start()
    {
        try
        {
            ...
            //Verticiesの頂点からランダムに取り出す

            Vector3[] comentPos = vertices;
            ...
            foreach (Vector3 vertex in vertices)
            {
                ...
                //乱数を生成
                var r = r2.Next(0, JSON_DATAS.Count);
                //json
                var comment = JSON_DATAS[r].Comment;
